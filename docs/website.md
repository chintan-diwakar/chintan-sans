# Use StayLabs Sans on a website

Use the light build. One variable file covers weights 100 to 900. A typical English page downloads 98 KB. Italic and accented European text download extra files only when those characters appear.

Do not link `css/staylabs.css` on a website. That file lists every static weight and is for the specimen, not for production.

## Files to copy

```
css/staylabs-web.css
fonts/web/StayLabsSans-latin.woff2
fonts/web/StayLabsSans-latin-ext.woff2
fonts/web/StayLabsSans-Italic-latin.woff2
fonts/web/StayLabsSans-Italic-latin-ext.woff2
```
...
```html
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/chintan-diwakar/staylabs-sans@v1.100/css/staylabs-web.css">
```
...
```html
<link rel="preload" href="/fonts/web/StayLabsSans-latin.woff2" as="font" type="font/woff2" crossorigin>
<link rel="stylesheet" href="/css/staylabs-web.css">
```
...
```css
body {
  font-family: "StayLabs Sans", sans-serif;
  font-weight: 400;
  font-synthesis: none;
...
| Page text | Download |
| --- | --- |
| English, or other Latin text | `StayLabsSans-latin.woff2`, 98 KB |
| Italic on that page | plus `StayLabsSans-Italic-latin.woff2`, 107 KB |
...
Greek and Cyrillic are not in the light build. For those, use `fonts/variable/StayLabsSans-Variable.woff2` (about 344 KB) instead of the Latin subset.
...
- `font-family` lists that name both "StayLabs Sans" and "StayLabs Sans Variable". The light CSS uses one family name.
