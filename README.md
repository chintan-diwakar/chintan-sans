...
StayLabs Sans is a screen face for a product interface. It is a derivative of [Inter](https://github.com/rsms/inter) 4.2, aimed at the same kind of app face as Atlassian Sans. Inter is a Reserved Font Name, so this family has its own name. It is not Atlassian Sans, and Atlassian does not endorse it.

Atlassian documents their app face as Inter with a fixed set of alternates always on. StayLabs Sans bakes those in:
...
| Path | Use |
| --- | --- |
| `css/staylabs-web.css` | Website stylesheet. See [docs/website.md](docs/website.md). |
...
| `css/staylabs.css` | Full specimen stylesheet, not the website default |
...
SIL Open Font License 1.1. See [OFL.txt](OFL.txt). You can bundle StayLabs Sans with a product. You cannot sell the font files by themselves, and you cannot rename a modified version back to Inter.

StayLabs Sans is not endorsed by Rasmus Andersson or the Inter project.
